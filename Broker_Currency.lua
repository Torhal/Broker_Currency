...
local ORDERED_CURRENCIES = {
	...
	-- Professions
	-------------------------------------------------------------------------------
	CURRENCIES.DALARAN_JEWELCRAFTERS_TOKEN,
	CURRENCIES.EPICUREANS_AWARD,
	CURRENCIES.ILLUSTRIOUS_JEWELCRAFTERS_TOKEN,
	CURRENCIES.IRONPAW_TOKEN,
	CURRENCIES.ZEN_JEWELCRAFTERS_TOKEN,
	CURRENCIES.SECRET_OF_DRAENOR_ALCHEMY,
	CURRENCIES.SECRET_OF_DRAENOR_BLACKSMITHING,
	CURRENCIES.SECRET_OF_DRAENOR_JEWELCRAFTING,
	CURRENCIES.SECRET_OF_DRAENOR_LEATHERWORKING,
	CURRENCIES.SECRET_OF_DRAENOR_TAILORING,
	-------------------------------------------------------------------------------
	-- Archaeology
	-------------------------------------------------------------------------------
	CURRENCIES.ARAKKOA_ARCHAELOGOY_FRAGMENT,
	CURRENCIES.DRAENEI_ARCHAEOLOGY_FRAGMENT,
	CURRENCIES.DRAENOR_CLANS_ARCHAEOLOGY_FRAGMENT,
	CURRENCIES.DWARF_ARCHAEOLOGY_FRAGMENT,
	CURRENCIES.FOSSIL_ARCHAEOLOGY_FRAGMENT,
	CURRENCIES.MANTID_ARCHAEOLOGY_FRAGMENT,
	CURRENCIES.MOGU_ARCHAEOLOGY_FRAGMENT,
	CURRENCIES.NERUBIAN_ARCHAEOLOGY_FRAGMENT,
	CURRENCIES.NIGHTELF_ARCHAEOLOGY_FRAGMENT,
	CURRENCIES.OGRE_ARCHAEOOGY_FRAGMENT,
	CURRENCIES.ORC_ARCHAEOLOGY_FRAGMENT,
	CURRENCIES.PANDAREN_ARCHAEOLOGY_FRAGMENT,
	CURRENCIES.TOLVIR_ARCHAEOLOGY_FRAGMENT,
	CURRENCIES.TROLL_ARCHAEOLOGY_FRAGMENT,
	CURRENCIES.VRYKUL_ARCHAEOLOGY_FRAGMENT,
	-------------------------------------------------------------------------------
	-- Items
	-------------------------------------------------------------------------------
